...
(cffi:defcfun ("_dSafeNormalize3" #.(swig-lispify-noprefix "_dSafeNormalize3" 'function)) :int
  (a :pointer))

(cffi:defcfun ("_dSafeNormalize4" #.(swig-lispify-noprefix "_dSafeNormalize4" 'function)) :int
  (a :pointer))

(cffi:defcfun ("_dNormalize3" #.(swig-lispify-noprefix "_dNormalize3" 'function)) :void
  (a :pointer))

(cffi:defcfun ("_dNormalize4" #.(swig-lispify-noprefix "_dNormalize4" 'function)) :void
  (a :pointer))
...
(cffi:defcfun ("dWorldStep" #.(swig-lispify-noprefix "dWorldStep" 'function)) :void
  (arg0 :pointer)
  (stepsize :float))
...
(cffi:defcfun ("dWorldQuickStep" #.(swig-lispify-noprefix "dWorldQuickStep" 'function)) :void
  (w :pointer)
  (stepsize :float))
...
(cffi:defcfun ("dWorldStepFast1" #.(swig-lispify-noprefix "dWorldStepFast1" 'function)) :void
  (arg0 :pointer)
  (stepsize :float)
  (maxiterations :int))

(cffi:defcfun ("dWorldSetAutoEnableDepthSF1" #.(swig-lispify-noprefix "dWorldSetAutoEnableDepthSF1" 'function)) :void
  (arg0 :pointer)
  (autoEnableDepth :int))

(cffi:defcfun ("dWorldGetAutoEnableDepthSF1" #.(swig-lispify-noprefix "dWorldGetAutoEnableDepthSF1" 'function)) :int
  (arg0 :pointer))
